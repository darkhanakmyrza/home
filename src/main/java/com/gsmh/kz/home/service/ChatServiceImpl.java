...
public class ChatServiceImpl implements ChatService {
  ...
  private ChatDto messageBoxToChatDto(MessageBox messageBox, Long currentUserId) {
    ...
    return new ChatDto(messageBox.getId(), secondUser.getFirstName(), secondUser.getId(), status, messageBox.getUpdatedDate(), lastMessage.getText(), lastMessage, secondUser.getAvatarUrl());
  }
